...
.main-container {
  ...
  background-image: radial-gradient(rgba(0, 0, 0, 0.085) 2px, transparent 0);
...
<template>
  <div class="main-container">
    <form class="form_container" method="post">
      <div class="logo_container"><img src="@/assets/main_logo.png" alt="" width="130" /></div>
      ...
      <div class="input_container">
        ...
        <input placeholder="name@mail.com" title="email" name="email" type="email" class="input_field" id="email" />
      </div>
      <div class="input_container">
      ...
      <div class="input_container">
        ...
        <input placeholder="confirm_password" title="confirm_password" name="confirm_password" type="password"
          class="input_field" id="confirm_password" />
      </div>
      <button title="Sign In" type="submit" class="sign-in_btn">
        <span>Sign In</span>
      </button>
      <v-btn title="Login" type="button" to="/login" class="bg-success" width="57%">
        <span>Login</span>
      </v-btn>
