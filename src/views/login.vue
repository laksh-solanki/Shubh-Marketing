...
<template>
  <div class="main-container">
    <form class="form_container" method="post">
      ...
      <button title="login" type="submit" id="submit" class="login_btn">
        <span>Log In</span>
      </button>
      <v-btn title="register" type="button" to="/register" class="bg-success">
...
import { loginUser } from '../Autho.js'
